<?php
function tree($Comment,$parent_id)
   { 
        echo '<ul>';
        foreach($Comment[$parent_id] as $key=>$value)
        {

            echo ' <li id="'.$value["id"].'li"> <div class="newComment clearfix">
        ...
        echo "</ul>";
    }//Вывод комментариев с помощьру Рекурсивной функции
tree($Comments,0);
?>